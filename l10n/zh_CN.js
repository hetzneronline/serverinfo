OC.L10N.register(
    ...
    "Upload max size" : "最大上传大小",
    "Type" : "类型",
    "You can connect an external monitoring tool by using this end point" : "您可以使用此端点连接外部监视工具",
    "To use an access token, please generate one then set it using the following command" : "要使用访问令牌，请生成一个，然后使用以下命令设置它"
},
"nplurals=1; plural=0;");
