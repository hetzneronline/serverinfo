OC.L10N.register(
    ...
    "RAM: Total: {memTotalBytes}/Current usage: {memUsageBytes}" : "Оперативна пам’ять: разом {memTotalBytes}/використовується: {memUsageBytes}",
    "RAM info not available" : "Інформація про оперативну пам'ять недоступна",
    "SWAP: Total: {swapTotalBytes}/Current usage: {swapUsageBytes}" : "Файл підкачки: разом {swapTotalBytes}/використовується {swapUsageBytes}",
    ...
    "Federated sent" : "Надіслано об'єднаній хмарі",
    "Federated received" : "Отримано від об'єднаної хмари",
    ...
    "Type" : "Тип",
    "You can connect an external monitoring tool by using this end point" : "За допомогою цієї адреси можна підключити зовнішній інструмент моніторингу сервера",
